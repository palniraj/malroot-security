...
require_once MALROOT_DIR . 'includes/scanners/class-mr-scanner-backdoor.php';
require_once MALROOT_DIR . 'includes/class-mr-cleanup.php';
require_once MALROOT_DIR . 'includes/class-mr-hardening.php';
